 ...
 * @author satvik
 */
public class FindFaculty extends javax.swing.JFrame {

    /**
     * Creates new form FindFaculty
     */
    public FindFaculty() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Faculty Search");
        ...
        //System.out.println(i);
         try{
            ...
            Statement stmt=con.createStatement();
                g="select * from faculty where fid="+(String.valueOf(i));
       ...
       int i;
        ...
        //System.out.println(i);
         try{
            ...
            Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","Aston_martin1");
            Statement stmt=con.createStatement();
                g="select * from student where faculty_id="+(String.valueOf(i));
               ResultSet rs=stmt.executeQuery(g);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FindFaculty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FindFaculty().setVisible(true);
            }
        });
    }
